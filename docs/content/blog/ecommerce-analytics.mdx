...
Add the Rybbit tracking script to your site's header. For most e-commerce platforms, this goes in your theme's template file. Refer to the [official Rybbit documentation](/docs/script) for the correct installation steps.
...
See the [Rybbit event tracking documentation](/docs/track-events) for specific implementation details on how to track these events properly for your platform.
...
For more detailed tracking beyond page views, refer to the [Rybbit event tracking documentation](/docs/track-events) for implementation guidance on:
