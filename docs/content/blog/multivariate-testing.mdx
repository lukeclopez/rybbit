...
![Rybbit Dashboard Analysis](/blog/rybbit_main_dashboard.png)

The Events section in Rybbit allows you to view and compare custom event data across your variations, making it simple to see which combination is winning.
